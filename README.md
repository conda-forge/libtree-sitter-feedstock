About libtree-sitter-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libtree-sitter-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libtree-sitter-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libtree-sitter
# for installing globally
pixi global install libtree-sitter
```
...
It is possible to list all of the versions of `libtree-sitter` available on your platform:
...
```
pixi search libtree-sitter --channel conda-forge
```
